            ...
            <div class="row">
                        ...
                        <div class="product-single__image">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    @php
                                        $images = json_decode($product->images); // Giải mã chuỗi JSON thành mảng
                                    @endphp
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    @foreach ($images as $image)
                                        <div class="swiper-slide product-single__image-item"><img loading="lazy"
                                                class="h-auto" src="{{ asset($image) }}" width="104" height="104"
                                                alt="" /></div>
                                    @endforeach
                ...
                <div class="col-lg-5">
                    <div class="d-flex justify-content-between mb-4 pb-md-2">
                        <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
                            ...
                            <a href="/danh-muc/{{ $product->menu->id }}-{{ Str::slug($product->menu->name) }}.html"
                                class="menu-link menu-link_us-s text-uppercase fw-medium">{{ $product->menu->name }}</a>
                            <span class="breadcrumb-separator menu-link fw-medium ps-1 pe-1">/</span>
                            <a href=""
                    ...
                    <div class="product-single__price">
                        <span class="current-price">{{ \App\Helpers\Helper::price($product->price, $product->price_sale) }}
                            VNĐ</span>
                    </div>
                    ...
                    <form action="/add-cart" method="post">
                        ...
                        <div class="product-single__addtocart">
                            ...
                            <button type="submit" class="btn btn-primary btn-addtocart ">Thêm vào giỏ
                                hàng</button>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="tab-description" role="tabpanel"
                        ...
                        <div class="product-single__description">
                            <h3 class="block-title mb-4">Mô tả chính về sản phẩm</h3>
                            ...
                            <div class="swiper-slide product-card">
                                ...
                                <div class="pc__info position-relative">
                                    ...
                                    <div class="product-card__price d-flex">
                                        <span
                                            class="money price">{{ \App\Helpers\Helper::price($product->price, $product->price_sale) }}</span>
                                    </div>
